...
> [!note] Второе исполнение кассы
> Кроме кассы на компьютере с отдельным фискальным регистратором и банковским терминалом есть исполнение «всё в одном» — смарт-терминал, где касса, фискальная часть и приём карт в одном корпусе. Клиентское описание — [[Касса 3 в 1]]; там же перечислено, чего на таком устройстве нет (зал и столы, кухонные экраны, заказы агрегаторов, лояльность).
...
Развилки открытия (O4a–O4d) и закрытия (чисто / расхождения / частичная сверка / ошибка кассы) описаны выше и полностью — в матрица состояний смены (спека в vault).
